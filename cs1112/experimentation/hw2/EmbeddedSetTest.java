...
class EmbeddedSetTest {

	public static String[] wordsFound = new String[0];

	public static void main(String[] args) {
		String cipher = "WoHellorld";
        String[] dict = { "HELLO", "WORLD" };
		String[] results = extractWords(cipher.toCharArray(), dict);
    ...
    public static String[] extractWords( char[] cipher, String[] dictionary ) {
		...
		for (int k = 0; k < wordsFound.length; k++) {
			System.out.println(wordsFound[k]);
		}
		System.out.println("Words Found: " +  wordsFound.length);
	...
	public static String[] simplify(char[] cipher, String[] dictionary, String[] wordsFound) {
		for (int i = 0; i < dictionary.length; i++) {
			...
			if (start != -1) {
				// Append found word to words found
				...
				// Recursive Case - append the result of extract words with the newly simplified cipher
