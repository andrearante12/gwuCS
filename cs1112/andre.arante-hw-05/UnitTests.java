...
Unit tests that verify the integrety of the Banking system
...
public class UnitTests {
    ...
    public static boolean unitTest3_3() {
        Transaction t = new Transaction(24, 4, "5 20 -");
        // Verify the account number
    ...
    public static boolean unitTest3_5() {
        Transaction t = new Transaction(77, 4, "5 20 /");
        // Verify the account number
    ...
    public static boolean unitTest3_7() {
        Transaction t = new Transaction(1, 4, "3.10 2.50 - 4.20 5.30 + *");
        // Verify the account number
        if (t.getAccountNumber() != 1) {
            System.out.println("Account number is not 1");
            return false;
        ...
        if (Math.round(t.getAmount()*100)/100D != 5.7) {
